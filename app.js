...
var incompleteTaskHolder=document.getElementById("incompleted");//ul of #incompleted tasks
var completedTasksHolder=document.getElementById("completed");//ul of #completed tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='task__record tasks__label';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className = "task__check";
    editInput.type="text";
    editInput.className="task__record task__input";
